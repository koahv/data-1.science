...
The team's results will be published online in the Journal of Geophysical Research: Space Physics on March 12.The above story is based on materials provided by Space Telescope Science Institute (STScI). Note: Materials may be edited for content and length.
The Daily Galaxy via Credit: NASA, ESA, and J. Saur (University of Cologne, Germany)
Related articles

Image of the Day: An Exploding Light Show in a Milky Way Satellite Galaxy
"Beyond Hubble" --A New 3-D View of the Earliest Galaxies in the Universe
