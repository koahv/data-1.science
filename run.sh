#rm out.txt
wget https://o0-770.rhcloud.com/out.txt
mv out.txt index.html

wget -O feed.xml "https://o0-770.rhcloud.com/public.php?op=rss&id=-1&key=vyn7su59c7b50850ac3"

sed -i -e 's/o0-770.rhcloud.com/ /g' feed.xml
